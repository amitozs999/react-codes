...
fetch("https://fakestoreapi.com/products")
  ...
  .then((res) => {
    ...
    data.forEach((val) => {
      ...
      let tempparDiv = document.createElement("div");

      //star rating div create, then attach with tempardiv
      ...
      tempparDiv.appendChild(allStarDiv);

      // ${tempparDiv.innerHTML} = star wala div add it dynamically in card bellow

      // add this card also in container code
